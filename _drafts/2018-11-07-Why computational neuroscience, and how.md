---
layout: post
title: Why computational neuroscience, and how?
author: Binxu Wang
use_math: true
comments: true
...
特别的是, 生物可以学习. 可以学习指令, 学习任务, 提升任务上的performance, 并且也可以在

neural coding / neural circuit

**系统性思考** 



**计算手段帮助我们快捷迅速省钱的回答问题** 这一点现在的Bioinformatics已经证明了, 
...
没有模型, 我们无法去产生假设, 无法去理解一个系统. 就像蛋白质相互作用网络一样,
...
也许是用类似神经元的计算结构能实现诸多信息处理功能这一点早就不新鲜了, 几十年前人们第一次发现perceptron时的激动经过几十年的adapt早已经不可见了. 这也是为何现在再用各种神经模型去实现计算功能(实现矩阵运算, 实现), 用神经学习模型去

更具体的说, 利用神经计算的模型去搭建智能信息处理系统的理想, 在过去5-6年的人工智能革命中已经很大程度上被实现, 而许多人满足于这一状态, 并不感兴趣进一步研究神经, 并从中获取灵感开发系统了. 

缺少对实验的predictability以及万能的解释性, 也许是另一个模型越来越不被人在意的原因. 
