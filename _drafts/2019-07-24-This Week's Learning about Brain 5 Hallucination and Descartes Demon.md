---
layout: post
title: This Week's Learning about Brain 5 Hallucination and Descartes' Demon (II)
author: Binxu Wang
use_math: true
comments: true
...
对于脑损伤的病人的观察也得出了类似的结论. 失去部分或全部初级视皮层的病人还是能做有视觉表象的梦(visual dream); 单侧额叶与顶叶损伤(prefrontal & prietal 一般认为是复杂认知与控制的中心)的病人会整体上停止做梦; 有趣的是, 那些双侧颞枕叶切除的病人(medial occipitotemporal region 一般认为的高级视觉区域)会特异性的失去做视觉梦的能力!! 而且那些只会做非视觉梦的人, 也总是同时患有视觉回忆障碍, 以及某种视觉认知障碍(visual agnosia)比如脸盲症(prosopagnosia)等. 这些症状也通常与视觉高级皮层有关[^74]. 
...
[^74]: 2002 NEURAL CORRELATES OF CONSCIOUSNESS IN HUMANS
...
![image-20190723180707593](/Users/binxu/Documents/Blog%20site/Animadversio.github.io/assets/img/posts/Visual_consciousness/image-20190723180707593.png)
