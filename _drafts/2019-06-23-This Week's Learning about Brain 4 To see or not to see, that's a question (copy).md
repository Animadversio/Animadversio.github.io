...
# 看得见还是看不见, 这是一个问题！
如果简单地问你, 你现在看到了什么, 你可以不假思索地说, 就是眼前的屏幕嘛. 如果稍微受过一点生理学或者神经科学训练的人也许会说, 是这个充满电磁波的世界里, 光学波段辐射被眼球的光学元件折射之后, 落在我们视网膜上的影像. 
...
我们可以拍脑门的说, 当我们*用心*去看就能看到(比如黑板或者窗外), 如果*不用心*, 那刺激就被我忽视(Neglect)了嘛——的确没错, 这就将我们引导到了视觉注意(Visual Attention)的领地. 不过这篇post中我们先不讨论注意的问题, 而要去关注一些与视觉意识相关的更基本的情况. 
...
![demo_noise_mask](/demo_character.gif)
...
总而言之, V1单神经元的神经活动与视觉表象的活动模式有许多不一致, 包含的信息也超出了视觉意识的范围, 同时并不足够解释/支撑视觉意识——所以在这篇[^0]综述中作者的结论就是我们意识不到V1的神经活动, 就像我们意识不到视网膜上细胞的活动一样. 也许V1中神经元集群的活动模式能更好的与视觉表象关联, 也许是某种更复杂的脑区间交互作用模式才带来了意识, 但这些都需要更好更大规模的神经记录手段才能了解.  
