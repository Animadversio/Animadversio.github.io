...
* 
* Behaviorism!
* General Process Approach: all behavior all come from 
...
* Causation (Proximal cause / Mechanism / Neuroscience / Physiology):
* Development (ontogeny): 
* Evolution (phylogeny): 
* Function (Adaptive significance / value for the animal)
...
* Use behavior as **proxy** for cognition
  * However, no behavior doesn't mean no inner process. No Equivalent!
* Training / Conditioning to solve the issue
...
* **Clever Hans**! Expectancy effect influence behavior! 
...
Tackles the ultimate questions! 



Different level of biology
